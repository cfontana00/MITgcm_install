...
!        O5c                                                      Calcite         mg C/m3
       ...
       integer,public,pointer,dimension(:)  :: D2STATEOBC_BEN
        ...
        integer,parameter,public  ::NO_D3_BOX_DIAGNOSS = 100

        integer,parameter,public  ::NO_D2_BOX_DIAGNOSS = 164

        integer,parameter,public  ::NO_D3_BOX_FLUX     = 2
...
! BFM1D_exR2ac(iiP1)                                                      Diatoms      mg C/ m3/d
! BFM1D_exR2ac(iiP2)                                                  Flagellates      mg C/ m3/d
! BFM1D_exR2ac(iiP3)                                            PicoPhytoplankton      mg C/ m3/d
! BFM1D_exR2ac(iiP4)                                          Large Phytoplankton      mg C/ m3/d
...
! ELiPPY(iiP4)                                          Large Phytoplankton            W/m2
    ...
    ppESS=5, ppEPR=6, ppDepth=7, ppVolume=8, ppArea=9, ppDIC=10, ppCO2=11, &
    ...
    ppeO2mO2=24, ppChla=25, ppffCO2=26, ppflPTN6r=27, ppflN3O4n=28, &
    ppflN4N3n=29, ppsediR2=30, ppsediR6=31, ppsediO5=32, ppxEPS=33, &
    ppABIO_eps=34
    ...
    ppBFM1D_exR2ac(iiPhytoPlankton), ppqpcMEZ(iiMesoZooPlankton), &
   ...
   real(RLEN),public,dimension(:),pointer  :: ETW, ESW, ERHO, EIR, ESS, EPR, &
    Depth, Volume, Area, DIC, CO2, pCO2, HCO3, CO3, ALK, pH, OCalc, OArag, &
    totpelc, totpeln, totpelp, totpels, cxoO2, eO2mO2, Chla, ffCO2, flPTN6r, &
    flN3O4n, flN4N3n, sediR2, sediR6, sediO5, xEPS, ABIO_eps

        real(RLEN),public,dimension(:,:),pointer  :: qpcPPY, qncPPY, qscPPY, &
    qlcPPY, qccPPY, BFM1D_exR2ac, qpcMEZ, qncMEZ, qpcMIZ, qncMIZ, qpcOMT, &
    qncOMT, qscOMT, qpcPBA, qncPBA, sediPPY, sediMIZ, sediMEZ, sunPPY, eiPPY, &
    ELiPPY
...
!       EICE                                             Sea-ice fraction               -
    ...
    ppThereIsLight=4, ppSUNQ=5, ppEWIND=6, pptotsysc=7, pptotsysn=8, &
    pptotsysp=9, pptotsyss=10, ppEICE=11


   real(RLEN),public,dimension(:),pointer  :: EPCO2air, CO2airflux, Area2d, &
    ThereIsLight, SUNQ, EWIND, totsysc, totsysn, totsysp, totsyss, EICE
    ...
    jrivR3c, jrivR6c, jrivR6n, jrivR6p, jrivR6s, jrivO3c, jrivO3h, jrivO5c
        ...
        real(RLEN),public ,dimension(:),allocatable    :: BAC_ACT_FACT ! Bacteria activity factor depth dependent
